...
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            $sql = "SELECT id, nome, numero_familia, hora_inicio, hora_final, data_inicio, area_consulta, especializacao FROM eventoscalendar  eventoscalendar WHERE especializacao = 'psicologo'";
