...
<body>
    ...
    <div class="container">
        <header>
            <h3>Consultas Agendadas > Medicina</h3>
        </header><br>
        ...
        <table>
            ...
            //Mostrar a banco de dados
            $sql = "SELECT id, nome, numero_familia, hora_inicio, hora_final, data_inicio, area_consulta, especializacao FROM eventoscalendar WHERE especializacao = 'medico'";
